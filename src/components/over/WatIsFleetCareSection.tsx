        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[1fr_2fr] lg:items-start">
            <div className="text-left">
              <h2 className="text-2xl font-bold text-brand md:text-3xl" data-reveal="fade-up">
                Wat is FleetCare
                <br />
                Connect
              </h2>
            ...
            <div>
              <p
                ...
                data-delay="0.05"
              >
                FleetCare Connect (FCC) is hét centrale aftersalesplatform voor Light Electric
                Vehicles (LEV&apos;s). Wij brengen gecertificeerde servicepartners en LEV-gebruikers
                samen, om onderhoud, reparaties en pechhulp eenvoudig en betrouwbaar aan te bieden.
              </p>
              <h3 className="mt-10 text-lg font-semibold text-brand" data-reveal="fade-up">
                Met FCC kunt u:
              </h3>
              <ul
                className="mt-6 space-y-4 leading-relaxed text-neutral-600"
              ...
              >
                <li className="flex gap-4">
                  ...
                  <span>
                    In 1 minuut een aanvraag doen voor de oplossing die het beste bij uw situatie
                    past
                  </span>
                </li>
                <li className="flex gap-4">
